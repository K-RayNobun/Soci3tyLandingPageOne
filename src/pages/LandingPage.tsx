      ...
      <main className='pb-[150px] bg-[url("/grayn.png")] bg-sludge  -z-10 w-screen'>
        ...
        <section className="relative w-full z-20 px-[10%] sm:px-[15%] overflow-visible font-bold flex flex-col items-center text-center h-[600px] sm:h-[700px] md:h-[750px]">
          <div className='max-w-[800px]'>
            <h1 className='text-white text-[32px] font-blaak md:text-[48px] lg:text-[64px] mb-[25px] md:leading-[64px] lg:leading-[72px]'>
              Let's make your vision <br />
              <span className='text-indigo text-[40px] md:text-[60px] lg:text-[78px]'>
                a reality
              </span>
            </h1>
            <h5 className='text-white px-4 text-[18px] md:text-[20px] lg:text-[24px]'>
        ...
        <section className='relative md:mt-[0px] min-h-max md:pb-[100px] h-[720px] md:h-[1220px] lg:h-[1200px] flex flex-col items-center'>
          <div className='absolute top-0 left-0 -z-0 flex flex-col items-center h-[75%] w-full mt-[0px] bg-[url("/grainblue.jpg")] ' style={{ width: '100%', clipPath: 'polygon(0% 16%, 100% 0%, 100% 84%, 0% 100%)' }}>
          </div>
          <div className='w-[80%] z-10 sm:w-[70%] md:w-[50%] mt-28 md:mt-[10%] lg: mb-10 md:px-[10%] lg:px-[0px] flex flex-col items-center justify-center text-[18px] sm:text-[24px] text-center text-white'>
          ...
          <div className='sm:w-[80%] z-20 min-w-max mx-auto rounded-lg mt-4  md:h-[580px] lg:h-[780px]'>
            <div id="thead" className='relative h-[15%] py-5 text-center min-w-full bg-sludge rounded-t-2xl'>
            ...
            <div className='flex h-[80%] text-white text-xl md:text-[20px] lg:text-[24px] rounded-b-lg bg-gray-700 md:text-2xl font-bold justify-between gap-1'>
              <ul className='bg-sludge font-blaak flex flex-col justify-between pt-[3%] pb-10 px-4 md:px-8 w-[28%] text-center md:text-end rounded-bl-lg'>
          ...
          <button className='uppercase px-12 md:px-[3%] rounded-full mt-10 bg-greenie hover:bg-greenie/80 active:scale-[105%] text-[16px] md:text-[20px] px-[24px] py-[17px] md:py-[20px]'>
            Join the Network
          </button>
        </section>
        <div className='relative w-full flex justify-center overflow'>
          <div className='absolute z-10 mt-[-40%] left-[0%] rounded-full size-[600px] blur-2xl bg-greenie to-transparent opacity-20'></div>
          <img src="/logo.png" alt="" className='w-[180px] lg:w-[250px] mb-[-50px] z-20 overflow-visible' />
        </div>
        <section className='relative py-20 md:py-[120px] px-12 mt-[0px] min-h-max w-full lg:px-[20%] flex flex-col justify-between items-center clip-curve bg-black/30 overflow'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2  gap-[24px] lg:gap-[40px] md:text-[16px] max-w-[780px] md:max-w-[1200px]'>
        ...
        <section className='w-full py-24 mt-12 flex flex-col items-center text-[18px] md:text-[20px] lg:text-[24px]'>
          ...
          <div className='w-[100%] md:w-[60%] py-4 text-center flex flex-col items-center justify-center'>
            <div className='flex items-end mb-8 md:mb-1'>
              <h2 className='text-white font-blaak lg:text-[48px] sm:text-[32px]'>You own</h2>
              <img src="/logo_name.png" className='md:w-[120px] lg:w-[250px]' alt="Logo Name Unavailable" />
            </div>
            <div className='text-wrap lg:w-[80%]'>
          ...
          <button className='uppercase rounded-full mt-12 bg-greenie hover:bg-greenie/80 active:scale-[105%] text-[16px] md:text-[20px] md:px-[24px] md:py-[20px] lg:px-[45px] py-[25px]'>
            Join the movement
          </button>
        </section>
      </main>
